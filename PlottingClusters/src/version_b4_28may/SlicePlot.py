...
class SlicePlot:
    ...
    def SetPlotSpecifics( self ):
        ...
        self.sliceplotsigma_y_max   = 0.15
        ...
        #self.colorlist = [ 2, 4, 4, 6, 8, 9, 30, 40, 41, 43, 46 ]
...
SlicePlot.FitSlicesGaus = FitSlicesGaus
SlicePlot.FitOneSliceGaus = FitOneSliceGaus

SlicePlot.FitSlicesMax = FitSlicesMax
SlicePlot.FitOneSliceMax = FitOneSliceMax

from SlicePlot_plotting import *
SlicePlot.MakePlots_standard = MakePlots_standard
SlicePlot.MakePlots_standard_Gaus = MakePlots_standard_Gaus
SlicePlot.MakePlots_standard_Max = MakePlots_standard_Max
